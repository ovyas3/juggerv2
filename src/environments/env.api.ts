export const environment = {
    ...
    API_URL_NEW_1: 'https://live-api.instavans.com/api/thor/',
    API_URL_NEW_2: 'https://live-api.instavans.com/api/thor/v2/',
    API_URL_NEW_3: 'https://live-api.instavans.com/api/panther/',
    API_URL_NEW_4: 'https://live-api.instavans.com/api/flash/',
