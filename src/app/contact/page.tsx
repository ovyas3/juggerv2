...
function Contact() {
  ...
  const getContactDetails = async () => {
    try {
      const response = await httpsPost('contact_details/getContactDetails', contactDetailsPayload);
  ...
  useEffect(()=>{
    if(contactDetailsPayload.from && contactDetailsPayload.to) getContactDetails();
