...
import { X, Download, AlertTriangle, FileText, User, Phone, Building, Clock, CheckCircle, Circle , ChevronDown, ChevronUp } from 'lucide-react';
...
const DetailPanel: React.FC<DetailPanelProps> = ({ vehicle, onClose, isOpen }) => {
  ...
  return (
    <>
      ...
      <div  className={`detail-panel ${isOpen ? 'open' : ''} ${!isExpanded ? 'collapsed' : ''}`}>
        {/* Panel Header */}
