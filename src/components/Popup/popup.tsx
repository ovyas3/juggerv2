...
export const Popup = () => {
    ...
    <TableHead>
      <TableRow>
        <TableCell align="left" className='table-columns'>
          <TextField id="outlined-basic" label="Rake ID" variant="outlined" InputLabelProps={{
                classes: {
                    root: 'my-label-class',
                  },
                }}/>
  ...
  const TableRowComponent = () => (
    <TableRow
     ...
     >
       <TableCell align="center" className='table-rows'>18013109984</TableCell>
       <TableCell align="center" className='table-rows'>GPWIS</TableCell>
       <TableCell align="center" className='table-rows'>44</TableCell>
       <TableCell align="left" className='table-rows'>31/12/2022</TableCell>
       <TableCell align="left" className='table-rows'>31/12/2022</TableCell>
       <TableCell align="left" className='table-rows'>Dec 24</TableCell>
       <TableCell align="left" className='table-rows'>N/A</TableCell>
       <TableCell align="left" className='table-rows'>Dec 24</TableCell>
     </TableRow>
  );
  ...
  const ChildTableHeadComponent = () => (
    ...
    <TableRow>
      <TableCell align="left" className='table-columns'>
        <TextField id="outlined-basic" label="Wagon No." variant="outlined" className='rake-search' InputLabelProps={{
              classes: {
                  root: 'my-label-class',
                },
              }}/>
  ...
  const ChildTableRowComponent = () => (
    <TableRow
       ...
       className='table-rows-container'
     >
       <TableCell align="left" className='table-rows'>18013109984</TableCell>
