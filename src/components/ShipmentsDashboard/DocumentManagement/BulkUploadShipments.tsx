...
import { Dialog, DialogContent, IconButton, Box, CircularProgress } from '@mui/material';
...
const BulkUploadShipments: React.FC<BulkUploadShipmentsProps> = ({ 
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      showMessage(error.message || 'An error occurred while uploading the file', 'error');
    } finally {
