...
const DriverExpenses: React.FC<DriverExpensesProps> = ({
  ...
  const calculateTotals = (expenseList = expenses) => {
    ...
    const approvedTotal = expenseList.reduce(
      (sum, exp) => sum + (exp.approvedAmount || 0),
      0
    );
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoItem}>
            ...
            <TextField
              value={
                shipment?.pickDate
                  ? format(new Date(shipment.pickDate), "dd/MM/yyyy")
                  : ""
              }
              disabled
              fullWidth
                  ...
                  <TableCell className={styles.cell}>
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DatePicker
                        ...
                        onChange={(date) =>
                          handleDateChange(index, date as Date | null)
                        }
                        minDate={minDate}
                        maxDate={maxDate}
                        // renderInput={(params) => (
                  ...
                  <TableCell className={styles.cell}>
                    <div className={styles.actionButtons}>
                      ...
                      >
                        <CancelIcon
                          fontSize="small"
                          color={expenses.length <= 1 ? "disabled" : "error"}
                        />
                      </IconButton>
                    </div>
                  </TableCell>
