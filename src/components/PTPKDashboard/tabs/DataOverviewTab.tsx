...
const DataOverviewTab = ({tableData, isLoadingTable, filters}: any) => {
            ...
            <div className={styles.tableHeaderContent}>
              <div className={styles.tableTitle}>
                ...
                {/* <div className={styles.liveIndicator}>
                  <div className={styles.liveBadge}>Live Data</div>
            ...
            <table className={styles.dataTable}>
              ...
              <tbody>
                 {isLoadingTable ? (
                   ...
                   <tr>
                     <td colSpan={regions.length * 4 + 8} style={{ textAlign: "center", padding: "2rem", color: "#6a6f78ff", fontSize: "1rem", fontWeight: "500" }}>
                   ...
                   <tr key={`${mode.id}-${row.month}-${idx}`} className={styles.tableRow}>
                     ...
                     {regions.map(region => (
                       <td key={`distance-${region}`} className={styles.tableCell}>
                         <div className={styles.cellContent}>
                           {row.distance[region.toLowerCase()] ?? "-"}
                         </div>
                       </td>
                     ))}
                     <td className={styles.weightedAvgCell}>
                     ...
                     {regions.map(region => (
                       <td key={`quantity-${region}`} className={styles.tableCell}>
                         <div className={styles.cellContent}>
                           {row.quantity[region.toLowerCase()] ?? "-"}
                         </div>
                       </td>
                     ))}
                     <td className={styles.weightedAvgCell}>
